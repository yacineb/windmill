...
<Menu placement="bottom-end">
	<button
		slot="trigger"
		class="flex items-center text-xs border focus:outline-none focus:ring-4 rounded-md 
		text-gray-800 bg-white hover:bg-gray-100 focus:ring-gray-300 px-4 py-1.5"
	>
		Import/Export
	</button>
